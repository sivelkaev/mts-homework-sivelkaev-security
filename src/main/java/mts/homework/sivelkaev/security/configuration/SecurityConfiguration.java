    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("mts-homework-sivelkaev-security/auth/*").permitAll()
                        .requestMatchers("mts-homework-sivelkaev-security/admin").hasRole("ADMIN")
                        .requestMatchers("mts-homework-sivelkaev-security/user").hasRole("USER")
